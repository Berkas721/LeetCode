...
{
    /// <inheritdoc />
    public partial class AddedProblemAndTopic : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_ProblemTopics_Name", x => x.Name);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPremiumRequired = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Problems_Name", x => x.Name);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProblemsId = table.Column<long>(type: "bigint", nullable: false),
                    TopicsId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProblemProblemTopic", x => new { x.ProblemsId, x.TopicsId });
                    table.ForeignKey(
                        name: "FK_ProblemProblemTopic_ProblemTopics_TopicsId",
                        column: x => x.TopicsId,
                        principalTable: "ProblemTopics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProblemProblemTopic_Problems_ProblemsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProblemProblemTopic_TopicsId",
                table: "ProblemProblemTopic",
                column: "TopicsId");
